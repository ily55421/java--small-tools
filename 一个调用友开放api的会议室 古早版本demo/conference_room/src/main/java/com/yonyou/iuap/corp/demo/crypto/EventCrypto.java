...
public class EventCrypto {
    ...
    public String encrypt(String randomStr, String text) throws CryptoException {
        ...
        byte[] padBytes = com.yonyou.iuap.corp.demo.crypto.PKCS7Encoder.encode(byteCollector.size());
    ...
    public String decrypt(String text) throws CryptoException {
        ...
        try {
            // 去除补位字符
            byte[] bytes =com.yonyou.iuap.corp.demo.crypto.PKCS7Encoder.decode(original);
    ...
    public String encryptMsg(String msg, long timestamp, String nonce) throws CryptoException {
        ...
        // 加签
        String signature =com.yonyou.iuap.corp.demo.crypto.SHA1.getSHA1(token, String.valueOf(timestamp), nonce, encrypt);
